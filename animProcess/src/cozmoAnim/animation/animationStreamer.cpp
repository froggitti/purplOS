...
#endif
  CONSOLE_VAR_ENUM(int, kProcFace_GammaType,            CONSOLE_GROUP, IsXray() ? 3 : 0, "None,FromLinear,ToLinear,AddGamma,RemoveGamma,Custom");
  CONSOLE_VAR_RANGED(f32, kProcFace_Gamma,              CONSOLE_GROUP, IsXray() ? 2.6f : 1.0f, 1.f, 4.f);
